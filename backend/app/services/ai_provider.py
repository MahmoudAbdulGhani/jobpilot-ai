        ...
        try:
            response = self.client.responses.parse(
                ...
                instructions=(
                    ...
                    "only when supported by source facts. Use concise bullet blocks for role and project evidence; "
                    "keep each role's dates and achievements together. Reorder evidenced skills and examples by relevance "
                    "to the job description. Make the cover letter three or four concise, coherent paragraphs with a "
                    "specific evidence-backed opening, one or two relevant examples, and a brief closing "
                    "that restates an evidenced skill. "
