...
export default function Detail() {
  ...
  async function patch(body:Partial<JobInput>&{is_archived?:boolean},closeModal=true) { const updated=await api<Job>(`/jobs/${id}`,{method:'PATCH',body:JSON.stringify(body)}); setJob(updated); if(closeModal)setModal(null) }
