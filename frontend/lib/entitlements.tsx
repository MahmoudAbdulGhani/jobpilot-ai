...
export function stateLabel(state:FeatureUsage['state']){
  return {available:'Available',unavailable:'Provider unavailable or disabled',not_in_plan:'Not included in this plan',exhausted:'Allowance exhausted'}[state];
}
